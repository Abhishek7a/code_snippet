...
const ClipBoard = (WrappedComponent) => {
    const { globalVariable, updateGlobalVariable, dark, setDark } = useAppContext();
    ...
    const handleButtonClick = (event) => {
        updateGlobalVariable(event.target.value);
    };
    const showToast = () => {
                ...
                <div className="border border-gray-200 rounded-lg rounded-b-none bg-gray-900 dark:border-gray-600 dark:bg-gray-800 ">
                    <div className="flex justify-between w-full grid-cols-3 p-4  rounded-lg md:mt-28  sm:mt-32 mt-40 sm:grid-cols-2">
                        ...
                        <div className="items-center hidden mx-auto space-x-3 lg:flex">
                            ...
                            <button onClick={() => setmobile(1)} className={`${mobile === 1 ? "flex items-center justify-center p-2 text-xs font-medium   w-9 h-9 border-2  border-white rounded-lg toggle-dark-state-example hover:text-gray-600 focus:z-10  ring-gray-900 dark:bg-gray-800 focus:outline-none text-white dark:border-gray-600 dark:hover:text-gray-700  dark:hover:bg-gray-700" : "flex items-center justify-center p-2 text-xs font-medium text-gray-900 bg-white w-9 h-9 border-2 border-gray-800 rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-gray-700 focus:z-10 focus:ring-2 focus:ring-gray-900 "}`}>
                                <svg className="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 16.5h3M2 1h14a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z"></path></svg>
                            </button>
                        ...
                        <div className=' flex justify-end '>
                            <button onClick={() => updateTheme()} data-tooltip-target="default-navbar-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="mr-4 toggle-dark-mode flex items-center  justify-center w-9 h-9  text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-gray-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-700 dark:border-gray-900 dark:hover:text-gray-400 dark:hover:bg-gray-700">
