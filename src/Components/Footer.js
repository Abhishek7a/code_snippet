...
export default function Footer() {
    return (
        <footer className="text-gray-600 body-font z-50 bg-gray-50 ">
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 Code Snippet —
                        <a href="#" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">codesnippett@gmail.com</a>
                    </p>
