...
const ResponsiveGrid = (WrappedComponent, name) => {
    ...
    return function ResponsiveGrid() {
        return <div className="lg:mt-28 mt-16">
            ...
            <div className={`p-0 border-2 border-gray-900 pr-96 rounded-b-lg max-h-[500px] min-h-96 hide-scrollbar overflow-y-scroll dark:bg-gray-900 ${dark ? 'bg-gray-900' : 'light'}`} >
