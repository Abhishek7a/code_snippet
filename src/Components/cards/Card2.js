...
export default function Card2() {
    return (
        <div class='flex items-center justify-center min-h-screen'>
            <div class="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-gray-50 border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
                <div class="pb-6">
                    <div class="flex flex-wrap justify-center">
                        <div class="flex justify-center w-full">
                            <div class="relative">
                                <svg width="130px" height="130px" class="dark:shadow-xl border-gray-50 dark:border-gray-500 rounded-full align-middle absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px] bg-gray-100 dark:bg-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1F2937" strokeWidth="2.242">
                                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" strokeLinejoin="round" stroke="#111827" strokeWidth="0.036"></g>
