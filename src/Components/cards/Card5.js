					...
					<div class="shadow p-4 rounded-lg bg-white">
							...
							<div class="absolute flex justify-center bottom-0 mb-3">
								<div class="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
									...
									<p class="flex items-center font-medium text-gray-800">
										...
										2
									</p>									<p class="flex items-center font-medium text-gray-800">
						...
						<div class="grid grid-cols-2 mt-8">
							<div class="flex items-center">
								<div class="relative">
									<svg width="30px" height="30px" class="dark:shadow-xl border-gray-50 dark:border-gray-500 rounded-full align-middle  max-w-[150px] bg-gray-100 dark:bg-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1F2937" strokeWidth="2.242">
