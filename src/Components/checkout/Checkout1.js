      ...
      <div className=" mx-auto ">
        <div className="lg:flex shadow-md ">
          <div className="lg:w-3/4 bg-white  lg:p-10 p-5 relative">
            ...
            {/* <h1 className='text-red-600 text-center text-xl pb-10'>Your Cart is Empty</h1>  */}
              <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" >
                  ...
                  <span className="text-center w-1/5 md:block hidden font-semibold text-sm">₹4.00</span>
                  <span className="text-center w-1/5 font-semibold text-sm">₹3.00</span>
                </div>
            <a to='/' className="flex font-semibold text-indigo-600 text-sm mt-10 absolute bottom-0  lg:bottom-5 ">
