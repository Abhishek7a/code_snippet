            ...
            <form>
              <div class="grid gap-y-4">
                <div>
                  ...
                  <div class="relative">
                    <input type="email" id="email" name="email" class="py-3 outline-blue-500 px-4 block w-full border-2 border-gray-200 dark:border-gray-500 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:bg-gray-700" required aria-describedby="email-error" />
                  </div>
