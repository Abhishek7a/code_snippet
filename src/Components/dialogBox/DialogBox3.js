...
export default function ResetPassword() {
  return (
    <body class="antialiased bg-slate-200 dark:bg-gray-900">
      <div class="max-w-lg mx-auto bg-gray-50 p-8 px-4 rounded-xl shadow shadow-slate-300 dark:bg-gray-800">
