...
export default function Ecommerce1(props) {
  ...
  const Mobile = () => {
    return <section className="text-gray-600 dark:bg-gray-900 dark:text-gray-50 body-font overflow-hidden">
      <div className="container px-4 py-16 mx-auto">
        <div className="mx-auto flex flex-wrap">
          <img src={shirt} alt="shirt" className="w-full h-auto object-cover object-center rounded" />
