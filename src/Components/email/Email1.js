...
export default function Email1(props) {
    const Desktop = () => {
        return <div class="w-full bg-gray-50 dark:bg-gray-900 shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar">
            ...
            <div class="flex-1 px-3">
                ...
                <div class="mb-6 pr-2 dark:bg-gray-900">
                    <div>
                        <input type="text" name="to" id="to" class="dark:bg-gray-800 mt-1 px-3 py-2 w-full text-gray-700 dark:text-gray-400  border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300 rounded-md" placeholder="To" />
                    </div>
                    <div>
                        <input type="text" name="cc" id="cc" class="dark:bg-gray-800 mt-1 px-3 w-full text-gray-700 dark:text-gray-400 py-2 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300 rounded-md" placeholder="Cc" />
                    </div>
                    <div>
                        <input type="text" name="bcc" id="bcc" class="dark:bg-gray-800 mt-1 px-3 w-full text-gray-700 dark:text-gray-400 py-2 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300 rounded-md" placeholder="Bcc" />
                    </div>
                    <div>
        ...
        return <div class="w-full bg-gray-50 dark:bg-gray-900 shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar">
            ...
            <div class="flex-1 px-3">
                ...
                <div class="mb-6 pr-2 dark:bg-gray-900">
                    ...
                    <div class="flex flex-wrap items-center gap-2 my-4 px-2">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div class="flex items-center space-x-2 px-2">
                            <button class="bg-blue-600 hover:bg-blue-700 rounded-lg px-12 py-1.5 text-gray-100 hover:shadow-xl transition duration-150">Send</button>
                            <button title="Attach Files">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-500 hover:text-gray-700 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"></path>
                                </svg>
