...
export default function Email2(props) {
                    ...
                    <div class="bg-gray-100 dark:bg-gray-900 mb-6">
                        <ul>
                            ...
                            <li class="flex items-center border-y hover:bg-gray-200 dark:hover:bg-gray-800 dark:text-gray-100 px-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        <div class="flex items-center mr-4 flex-col md:flex-row gap-2flex-col md:flex-row gap-2">
                                            <button title="Not starred">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-gray-900 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                </svg>
    ...
    const Tablet = () => {
        return <>
            <div class="w-full bg-gray-50 dark:bg-gray-900 shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar ">
                <div class="flex-1 ">
                    <button data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar" type="button" class="inline-flex items-center mt-2 text-sm rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-800 dark:focus:ring-gray-900  ml-2">
                        <span class="sr-only">Open sidebar</span>
                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                        </svg>
                    ...
                    <div class="py-3 flex-wrap flex items-center justify-between gap-3 mx-2">
                        ...
                        <div class="px-2 flex items-center w-full space-x-4 justify-end">
                            <span class="text-sm mx-2 w-24 dark:text-gray-50">1-15 of 1,323</span>
                            <div class="flex items-center space-x-2">
                                <button class="bg-gray-200 dark:bg-gray-800 dark:text-gray-500 text-gray-400 p-1.5 rounded-lg" title="Newer">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-gray-100 dark:bg-gray-900 mb-6">
                        <ul>
                            <li class="flex items-center border-y hover:bg-gray-200 dark:hover:bg-gray-800 dark:bg-gray-900 dark:text-gray-400 px-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        <div class="flex items-center sm:mr-4 mr-2 flex-col gap-2">
                                            <button title="Not starred">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-gray-900 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                </svg>
                            ...
                            <li class="flex items-center border-y hover:bg-gray-200 dark:hover:bg-gray-800 dark:text-gray-100 px-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    ...
                                    <div class="w-full flex items-end justify-end flex-col-reverse sm:flex-row">
                                        ...
                                        <span class="text-sm font-bold mx-1 w-12">
                                            Jan 29
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="flex items-center border-y hover:bg-gray-200 dark:hover:bg-gray-800 dark:text-gray-100 px-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        <div class="flex items-center mr-4 flex-col gap-2">
                                            <button title="Not starred">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-gray-900 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                </svg>
                                    ...
                                    <div class="w-full flex items-end justify-end flex-col-reverse sm:flex-row">
                                        ...
                                        <span class="text-sm font-bold md:mx-1 w-12">
                                            Jan 25
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="bg-gray-100 dark:bg-gray-900 mb-6">
                        <ul>
                            <li class="flex items-center border-y hover:bg-gray-200 dark:hover:bg-gray-800 dark:bg-gray-900 dark:text-gray-400 px-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        <div class="flex items-center mr-2 flex-col gap-2">
                                            <button title="Not starred">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-gray-900 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                </svg>
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                            <button title="Archive">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-gray-900 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20"></path>
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 font-bold truncate">Consectetur adipiscing elit Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 font-bold truncate">Sed do eiusmod Lorem ipsum dolor sit amet consectetur, adipisicing elit tempor incididunt</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate"> Lorem ipsum dolor sit amet consectetur, adipisicing elitLabore et dolore magna aliqua</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 text-center truncate">Ut enim ad minim veniam Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 font-bold truncate">Quis nostrud exercitation Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate"> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione, porroUllamco laboris nisi ut aliquip...</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div class="w-full flex items-center justify-between p-1 my-1 cursor-pointer">
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Commodo consequat Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Duis aute irure dolor Lorem ipsum dolor sit amet consectetur, adipisicing elit in reprehenderit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Voluptate velit esse cillum Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Dolore eu fugiat nulla pariatur Lorem ipsum dolor sit amet consectetur, adipisicing elit</span>
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class='flex flex-col'>
                                            ...
                                            <span class="w-48 truncate">Excepteur sint occaecat Lorem ipsum dolor sit amet consectetur, adipisicing elit</span >
                                        </div>
                                    </div>
                                    <div class="w-full flex items-end justify-end flex-col-reverse">
                                        <div class="flex items-center space-x-2">
