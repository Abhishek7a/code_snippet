            ...
            <div className="bg-dark_grey-900 md:p-10 ">
                <div className="max-w-screen-lg px-4 sm:px-4 text-white sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
                    <div className="lg:p-5 px-5 pr-10  ">
                        ...
                        <h3 className="font-bold text-xl pt-2">Code <span className=' text-red-600'>Snippet</span> </h3>
                    </div>
                    <div className="p-5">
...
max-w-screen-lg items-center">
           ...
           -0.416,-0.385l-0.519,0l0,-1.426l4.847,0l1.583,5.704l0.042,0l1.598,-5.704l5.021,0l0,1.426Z"></path>
                    ...
                    <div className="my-5 md:pb-0 pb-10">© Copyright 2024. All Rights Reserved.</div>
                </div>
            </div>
