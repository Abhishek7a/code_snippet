...
export default function Footer4(props) {
    const Desktop = () => {
        return <div className='dark:bg-gray-900 dark:text-gray-50 text-gray-800 bg-gray-100'>
    ...
    const Mobile = () => {
        return <div className='dark:bg-gray-900 dark:text-gray-50 text-gray-800 bg-gray-100'>
            <div className="w-full m-auto py-7 px-4 flex flex-col">
            ...
            <div className="">
                <div className="max-w-screen-lg px-4 mx-auto">
                    <div className="px-5 pr-10 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className='w-10 h-10 text-gray-800 dark:text-gray-50 mx-auto' viewBox="0 0 512 512"><path style={{ fill: "#E41F11", }} d="M0,260.908l174.648-81.136v38.568l-132.08,57.848v0.728l132.08,57.848v38.568L0,292.212V260.908z" /> <path style={{ fill: "currentcolor", }} d="M201.6,387.9l77.864-263.8h36.752L238.4,387.9H201.6z" /> <path style={{ fill: "#00008B", }} d="M512,293.284L337.352,373.34v-38.568l134.992-57.848v-0.728L337.352,218.34v-38.568L512,259.828 V293.284z" />
                        </svg>
                        <h3 className="font-bold text-xl">Code <span className='text-red-600'>Snippet</span> </h3>
                    </div>
                    <div className="p-2">
            ...
            <div className="max-w-2xl mx-auto  border-t border-b border-gray-800 dark:border-gray-50 p-4 mt-10 py-10 ">
                <div className="text-center">
                    <h3 className="text-3xl mb-3 ">Download our fitness app </h3>
                    <p> Stay fit. All day, every day.</p>
                    <div className="my-5 flex-col flex hover:cursor-pointer md:gap-3">
                        <div className="bg-gray-900 text-gray-200 flex items-center border rounded-lg p-3 w-48 mx-auto">
                            <svg
                        ...
                        <div className="bg-gray-900 text-gray-200 flex items-center border mt-2 rounded-lg px-4 py-3 w-48 mx-auto">
                            <svg
                                viewBox="0 0 15 15"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="dark:bg-grey-900 pt-2">
                <div className="flex pb-5 px-3 m-auto pt-5 w-5/6 text-sm flex-col max-w-screen-lg items-center">
                    <div className="flex-auto mt-2 flex-row flex">
                        <Link to="#" className="w-6 mx-1">
                            <svg className="fill-current cursor-pointer text-gray-500 hover:text-red-600" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" space="preserve" serif="http://www.serif.com/">
                                <path id="Twitter" d="M24,12c0,6.627 -5.373,12 -12,12c-6.627,0 -12,-5.373 -12,-12c0,-6.627 5.373,-12 12,-12c6.627,0 12,5.373 12,12Zm-6.465,-3.192c-0.379,0.168 -0.786,0.281 -1.213,0.333c0.436,-0.262 0.771,-0.676 0.929,-1.169c-0.408,0.242 -0.86,0.418 -1.341,0.513c-0.385,-0.411 -0.934,-0.667 -1.541,-0.667c-1.167,0 -2.112,0.945 -2.112,2.111c0,0.166 0.018,0.327 0.054,0.482c-1.754,-0.088 -3.31,-0.929 -4.352,-2.206c-0.181,0.311 -0.286,0.674 -0.286,1.061c0,0.733 0.373,1.379 0.94,1.757c-0.346,-0.01 -0.672,-0.106 -0.956,-0.264c-0.001,0.009 -0.001,0.018 -0.001,0.027c0,1.023 0.728,1.877 1.694,2.07c-0.177,0.049 -0.364,0.075 -0.556,0.075c-0.137,0 -0.269,-0.014 -0.397,-0.038c0.268,0.838 1.048,1.449 1.972,1.466c-0.723,0.566 -1.633,0.904 -2.622,0.904c-0.171,0 -0.339,-0.01 -0.504,-0.03c0.934,0.599 2.044,0.949 3.237,0.949c3.883,0 6.007,-3.217 6.007,-6.008c0,-0.091 -0.002,-0.183 -0.006,-0.273c0.413,-0.298 0.771,-0.67 1.054,-1.093Z"></path>
                            </svg>
                    ...
                    <div className="my-4 pb-0">© Copyright 2024. All Rights Reserved.</div>
                </div>
            </div>
