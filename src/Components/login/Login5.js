...
export default function Login5(props) {
    const Desktop = () => {
        return <>
            <body>
                        ...
                        <div class="bg-gray-100 dark:bg-gray-900 sm:w-1/2 mt-8 mx-auto px-4 py-8 rounded-lg shadow-2xl">
                            ...
                            <form class="my-8 text-sm">
                                <div class="flex flex-col my-4">
                                    ...
                                    <input type="text" name="name" id="name" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 dark:bg-gray-800" placeholder="Enter your name" />
                                </div>
                                <div class="flex flex-col my-4">
                                    <label for="email" class="text-gray-700 dark:text-gray-400">Email Address</label>
                                    <input type="email" name="email" id="email" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 dark:bg-gray-800" placeholder="Enter your email" />
                                </div>
                                <div class="flex flex-col my-4">
                                    <label for="password" class="text-gray-700 dark:text-gray-400">Password</label>
                                    <div class="relative flex items-center mt-2">
                                        <input id="password" class="flex-1 p-2 pr-10 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 dark:bg-gray-800" placeholder="Enter your password" type="password" />
                                ...
                                <div class="flex flex-col my-4">
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        <input
                                            name="password_confirmation" id="password_confirmation" class="flex-1 p-2 pr-10 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 dark:bg-gray-800" placeholder="Enter your password again" type="password" />
                                        <button
            ...
            <body>
                <div class="bg-gray-200 dark:bg-gray-800 w-full min-h-screen flex items-center justify-center">
                    <div class="w-full py-8">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-900 mt-8 mx-auto px-4 py-8 rounded-lg shadow-2xl">
                            <h2 class="text-center text-2xl font-bold tracking-wide text-gray-800 dark:text-gray-100">Sign Up</h2>
                            <p class="text-center text-sm text-gray-500 mt-2">Already have an account? <a href="#" class="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Sign in here</a></p>
                            <form class="my-8 text-sm">
                                <div class="flex flex-col my-4">
