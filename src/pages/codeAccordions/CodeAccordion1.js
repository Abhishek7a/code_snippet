...
export default function CodeAccordion1() {
    ...
    const Accordion1 = ClipBoard(accordion1);
    return (
        <div className='w-11/12 m-auto'>
            <Accordion1 />
            <pre className='mt-0'>
                <code ref={codeRef} className="language-html">{dark === false && globalVariable === 'HTML' ?
                    `<div class="mx-auto md:px-5 px-3 bg-gray-50 dark:bg-gray-900 dark:text-gray-50 min-h-sceen">
            ...
            <p className="text-gray-400 mt-3 group-open:animate-fadeIn">
                ...
                codesnippett@gmail.com
                        ...
                        : dark === true && globalVariable === 'HTML' ?
                            `<div class="mx-auto md:px-5 px-3 bg-gray-900 text-gray-50 min-h-sceen">
 <div class="flex flex-col items-center">
  <h2 class="font-bold text-5xl mt-5 tracking-tight">
    FAQ
  </h2>
    ...
    <details class="group">
      ...
      <p class="text-gray-400 mt-3 group-open:animate-fadeIn">
        ...
        codesnippett@gmail.com
                            ...
                            `<div className="mx-auto md:px-5 px-3 bg-gray-900 text-gray-50 min-h-sceen">
 <div className="flex flex-col items-center">
  <h2 className="font-bold text-5xl mt-5 tracking-tight">
    FAQ
  </h2>
